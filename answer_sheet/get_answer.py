...
# 正确答案
ANSWER_KEYS = {
    1: {0: 1, 1: 4, 2: 0, 3: 2, 4: 1},
    2: {0: 0, 1: 0, 2: 0, 3: 0, 4: 0},
    3: {0: 2, 1: 4, 2: 0, 3: 1, 4: 1},
    4: {0: 0, 1: 1, 2: 2, 3: 3, 4: 4},
    5: {0: 1, 1: 4, 2: 0, 3: 3, 4: 1},
}

if __name__ == '__main__':
    get('images/test_04.png', ANSWER_KEYS[4])
    exit()
    for key, answers in ANSWER_KEYS.items():
        file_path = 'images/test_{:02d}.png'.format(key)
        get(file_path, answers)
